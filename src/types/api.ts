// To parse this data:
//
//   import { Convert, TypesSpaceX } from "./file";
//
//   const typesSpaceX = Convert.toTypesSpaceX(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface TypesSpaceX {
    docs:          Doc[];
    totalDocs:     number;
    offset:        number;
    limit:         number;
...
export class Convert {
    public static toTypesSpaceX(json: string): TypesSpaceX {
        return cast(JSON.parse(json), r("TypesSpaceX"));
    }

    public static typesSpaceXToJson(value: TypesSpaceX): string {
        return JSON.stringify(uncast(value, r("TypesSpaceX")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Core": o([
        ...
        { json: "landpad", js: "landpad", typ: u(null, "") },
    ], false),
    "Failure": o([
